      ...
      <div className="relative hidden flex-col overflow-hidden bg-[#1a1a1a] p-12 lg:flex">
        ...
        <div className="mt-auto">
          <h2 className="text-[38px] font-bold leading-tight text-white">
            Your trusted<br />
            electronics<br />
            <span className="text-[#00796b]">marketplace.</span>
          </h2>
          <p className="mt-4 max-w-sm text-[14px] leading-relaxed text-white/40">
            Premium electronics, competitive prices, and nationwide delivery. Sign in to access your orders and wishlist.
          </p>
          ...
          <div className="mt-8 space-y-3">
            {[
              ...
              { icon: ShieldCheck,  label: "Secure checkout & payment" },
              { icon: RotateCcw,    label: "Easy returns & exchanges" },
            ].map(({ icon: Icon, label }) => (
